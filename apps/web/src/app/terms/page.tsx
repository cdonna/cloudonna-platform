    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-12">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-slate-600">
          <p>
            ClouDonna is provided as an early-stage, evolving product during
            the Public Alpha program. Full Terms of Service will be
            published here before general availability.
          </p>

          <PlaceholderSection title="Alpha program">
            Features, availability and functionality may change at any time
            without notice while ClouDonna is in Public Alpha.
          </PlaceholderSection>

          <PlaceholderSection title="Acceptable use">
            Detailed acceptable-use terms will be published here ahead of
